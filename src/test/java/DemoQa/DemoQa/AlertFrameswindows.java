...
public class AlertFrameswindows {
	...
	public void elements() throws InterruptedException {
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div)[32]")));
	...
	public void alertFramesandWindows() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div)[32]")).click();
	...
	public void broweserWindows() throws InterruptedException, AWTException {
		...
		wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[18]")));

		driver.findElement(By.xpath("(//span)[18]")).click();
		wait3 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait3.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#tabButton")));
	...
	public void alerts() throws InterruptedException {
		...
		wait4.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#confirmButton")));
		...
		wait5.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#promtButton")));
	...
	public void nestedFrames() throws InterruptedException, AWTException {
		...
		wait6.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[21]")));
...
//		driver.close();
	...
	public void modalDialogs() throws InterruptedException, AWTException {
		...
		wait7.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[22]")));
