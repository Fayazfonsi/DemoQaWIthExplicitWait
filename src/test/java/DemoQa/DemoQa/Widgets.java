...
public class Widgets {
	...
	WebDriverWait wait16;
	WebDriverWait wait17;
	WebDriverWait wait18;
	WebDriverWait wait19;
	WebDriverWait wait20;
	WebDriverWait wait21;
	WebDriverWait wait22;
	WebDriverWait wait23;
	WebDriverWait wait24;
	WebDriverWait wait25;
	...
	public void widgets2() throws InterruptedException, AWTException {
		...
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[24]")));

		driver.findElement(By.xpath("(//span)[24]")).click();
		wait2 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[25]")));
	}
	...
	public void Accordian() throws InterruptedException, AWTException {
		...
		wait3.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='card']//div[@id='section1Heading']")));
		...
		wait4.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='accordion']//div[@id='section2Heading']")));
		...
		wait5.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='card']//div[@id='section2Heading']")));
		...
		wait6.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='accordianContainer']//div[@id='section3Heading']")));
		...
		wait7.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='card']//div[@id='section3Heading']")));
	...
	public void datePicker() throws InterruptedException, AWTException {
		...
		wait8.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[27]")));

		driver.findElement(By.xpath("(//span)[27]")).click();

		wait9 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait9.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#datePickerMonthYearInput")));

		driver.findElement(By.cssSelector("#datePickerMonthYearInput")).click();
		wait10 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait10.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//select)[1]")));
		...
		wait10 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait10.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//select)[2]")));
		...
		wait11.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@role='listbox']//div[@aria-label='Choose Wednesday, August 2nd, 2023']")));
		...
		wait12.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#datePickerMonthYearInput")));
		...
		wait13.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div)[87]")));

		driver.findElement(By.xpath("(//div)[87]")).click();

		wait14 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait14.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div)[84]")));

		driver.findElement(By.xpath("(//div)[84]")).click();

		wait15 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait15.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div)[92]")));

		driver.findElement(By.xpath("(//div)[92]")).click();

		wait16 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait16.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@role='listbox']//div[@aria-label='Choose Monday, April 3rd, 2023']")));

		driver.findElement(By.xpath("//div[@role='listbox']//div[@aria-label='Choose Monday, April 3rd, 2023']"))
				.click();

		wait17 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait17.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li)[40]")));
		driver.findElement(By.xpath("(//li)[40]")).click();

		wait18 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait18.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#dateAndTimePickerInput")));
	...
	public void slider() throws InterruptedException, AWTException {
		...
		wait19 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait19.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[28]")));

		driver.findElement(By.xpath("(//span)[28]")).click();
//		wait20 = new WebDriverWait(driver, Duration.ofSeconds(20));
//		wait20.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\\\"sliderContainer\\\"]/div[1]/span/input")));
	...
	public void progressBar() throws InterruptedException, AWTException {
		...
		wait20 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait20.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span)[29]")));

		driver.findElement(By.xpath("(//span)[29]")).click();
		wait21 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait21.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#startStopButton")));
	...
	public void tabs() throws InterruptedException, AWTException {
		...
		wait22 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait22.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//li)[21]")));

		driver.findElement(By.xpath("(//li)[21]")).click();

		wait23 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait23.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#demo-tab-origin")));
	...
	public void toolTips() throws InterruptedException, AWTException {
		...
		wait24 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait24.until(ExpectedConditions.visibilityOfElementLocated(By.id("toolTipTextField")));
